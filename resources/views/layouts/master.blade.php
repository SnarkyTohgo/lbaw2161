                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="site-logo-wrapper">
                                    <a href="/" class="logo">
                                        <img class="landing-logo-size" src="images/logoAzulFundoTransparente_CUT.png" alt="logo">
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="about-wrapper">
                                    ...
                                    <div class="site-logo-wrapper mb-30">
                                        <a href="/" class="logo">
                                        <img class="footer-logo" src="images/logoAzulFundoTransparente.svg" alt="logo">
                                        </a>
                                    </div>
